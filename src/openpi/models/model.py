...
#     "action_region_mask": bool[*b, l],  # Optional, mask for FAST action token region
#
#      # Actions data.
...
class Observation(Generic[ArrayT]):
    ...
    # Token region mask for low-level subtask tokens.
    subtask_region_mask: at.Bool[ArrayT, "*b l"] | None = None
    # Token region mask for FAST action tokens.
