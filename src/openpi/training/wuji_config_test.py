...
def test_pi05_wuji_config_instantiates_with_54d_joint_action_space(monkeypatch):
    ...
    config = _config.get_config("pi05_wuji_spray_water_joint_pytorch")
    ...
    assert data_config.repo_id == "/data_all/liyunhao/openpi/data/spray_water_joint_rosbag_ts_filter"
    assert data_config.asset_id == "wuji_spray_water_joint"
